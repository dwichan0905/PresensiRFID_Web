...
<head>
    ...
    <title>Ubah Perangkat | <?= $app_name ?></title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li>
                                <i class="fa fa-hdd-o"></i> Ubah Perangkat
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <!-- isi disini -->
                                <form action="<?=base_url()?>devices/modify/<?= $id; ?>.me" method="POST">
                                    ...
                                    <div class="form-group input-group <?= (($errorOn == 'id') || ($errorOn == 'all') ? "has-error" : ""); ?>">
                                        ...
                                        <input type="text" name="id" maxlength="20" class="form-control" id="inputError" placeholder="Masukkan Device ID disini..." value="<?= $id; ?>" disabled="1">
                                    </div>
