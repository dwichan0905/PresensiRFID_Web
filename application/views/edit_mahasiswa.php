...
<head>
    ...
    <title>Ubah Mahasiswa | <?= $app_name ?></title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            <small>Ubah Data Mahasiswa</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                            ...
                            <li>
                                <i class="fa fa-users"></i> Ubah Mahasiswa
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <!-- isi disini -->
                                <form action="<?=base_url()?>mahasiswa/modify/<?= $nim ?>.me" method="POST">
                                    <input type="hidden" name="hnim" value="<?= $nim ?>"/>
                                    <input type="hidden" name="hcard" value="<?= $card ?>"/>
